...
<body>
                                ...
                                <div class="order-header container p-3" data-toggle="collapse" data-target="#order-1" aria-expanded="true">
                                    <div class="row">
                                        ...
                                        <div class="col-12 pt-3 order-actions">
                                            <button class="mark-all-available btn outline ripple w-100" data-toggle="modal" data-target="#modal-change-order-status">Carica</button>
                                        </div>
                                    </div>
                                </div>
    ...
    <div id="modal-change-order-status" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="width: 360px;">
                ...
                <div class="modal-body">
                    <p class="m-0">
                        Contrassegnare questo ordine come caricato?<br/>Tutti i prodotti con stato <b class="order-pending">In attesa</b> contenuti nell'ordine saranno contrassegnati come caricati.<br/><b>Attenzione</b>: questa operazione è irreversibile.
                    </p>
                </div>
            ...
            <div class="modal-content" style="width: 360px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <button class="btn accent ripple flex-grow-1 mb-2" data-dismiss="modal" data-toggle="modal" data-target="#modal-confirm-available">Caricato</button>
    ...
    <div id="modal-confirm-available" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="width: 360px;">
                ...
                <div class="modal-body">
                    <p class="m-0">
                        Contrassegnare questo prodotto come caricato? Nel caso in cui la quantità effettivamente caricata sia inferiore all'importo dell'ordine, è possibile modificarla.<br/><b>Attenzione</b>: questa operazione è irreversibile.
                    </p>
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="text-input flex-grow-1">
                            <input name="product-quantity" class="w-100" type="text" value="1"/>
    ...
    <script>
        $(document).ready(function() {
            $(document).on("click", ".mark-all-available, .show-client-info", function(event) {
