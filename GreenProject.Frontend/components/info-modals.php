<div data-template-name="ErrorModal" data-class="modal fade" class="d-none" tabindex="-1" role="dialog" aria-hidden="true">
...
<div data-template-name="InfoModal" data-class="modal fade" class="d-none" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="width: 360px;">
            <div class="modal-top text-center">
            ...
            <div class="modal-body">
                <p class="info-text m-0">Modal text</p>
            </div>
            <div class="modal-bottom bg-primary d-flex justify-content-center">
                <button class="btn outline ripple" data-dismiss="modal" style="width: 160px;">Ok</button>
            </div>
