<div class="sticky-top" style="top: 64px;">
    <a id="management-products-tab" href="/management/products"
        class="account-tab <?php echo $request == '/management/products' ? 'selected' : '' ?>"
    ...
    <a id="management-reports-tab" href="/management/reports"
        class="account-tab <?php echo $request == '/management/reports' ? 'selected' : '' ?>"
