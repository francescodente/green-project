            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 mb-4 mb-md-0">
                    ...
                    <form>
                        ...
                        <div class="text-center">
                            <button class="btn accent ripple px-4">
                                <span class="text-light">Invia</span>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 text-center mb-3">
                                ...
                                <h6 class="h-variant text-accent mb-3">E-mail</h6>
                                <p>
                                    <a href="mailto:info@fruitracers.com" class="text-dark" target="_top">info@fruitracers.com</a><br>
