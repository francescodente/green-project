...
<body>
    <div>
        ...
        <section id="account" class="parallax-container header d-flex justify-content-center align-items-center" data-section="account-business-orders">
        ...
        <section id="account-content" class="container py-4" data-section="account-business-orders">
