...
namespace GreenProject.Backend.DataAccess.Migrations
{
    ...
    [Migration("20200517213143_UpdateOrderNumberFormatting")]
    partial class UpdateOrderNumberFormatting
    {
            ...
            modelBuilder.Entity("GreenProject.Backend.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("OrderNumber")
                        ...
                        .HasComputedColumnSql("FORMAT(YEAR([Timestamp]), 'D4') + FORMAT(DATEPART(dayofyear, [Timestamp]), 'D3') + '-' + FORMAT([OrderId] % 100000, 'D5')");
            ...
            modelBuilder.Entity("GreenProject.Backend.Entities.Product", b =>
                {
                    ...
                    b.Property<int>("CrateMultiplier")
                        .HasColumnType("int");
